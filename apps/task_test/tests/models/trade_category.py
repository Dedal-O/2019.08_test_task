...
from apps.task_test.models import TradeCategoryModel
from django.utils.translation import gettext_lazy

__all__ = ('TradeCategoryModelsCase', )


class TradeCategoryModelsCase(TestCase):
    """
    ...
    def setUpClass(cls):
        ...
        TradeCategoryModel.objects.create(title='Some City Area or Disctrict')
        return super(TradeCategoryModelsCase, cls).setUpClass()
    ...
    def test_title_verbose_name(self):
        ...
        """
        area = TradeCategoryModel.objects.all().first()
