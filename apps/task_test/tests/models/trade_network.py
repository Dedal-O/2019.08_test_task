...
from apps.task_test.models import TradeNetworkModel
from django.utils.translation import gettext_lazy

__all__ = ('TradeNetworkModelsCase', )


class TradeNetworkModelsCase(TestCase):
    """
    ...
    def setUpClass(cls):
        ...
        TradeNetworkModel.objects.create(title='Some City Area or Disctrict')
        return super(TradeNetworkModelsCase, cls).setUpClass()
    ...
    def test_title_verbose_name(self):
        ...
        """
        area = TradeNetworkModel.objects.all().first()
